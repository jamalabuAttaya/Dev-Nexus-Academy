...
Route::prefix('v1')->middleware('throttle:api')->group(function (): void {
    ...
    Route::prefix('catalog')->group(function (): void {
        ...
        Route::get('/articles/{article}', [CatalogController::class, 'article'])->whereNumber('article');
    });
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::put('/lessons/{lesson}/progress', [LearningController::class, 'updateProgress']);
    });
});
